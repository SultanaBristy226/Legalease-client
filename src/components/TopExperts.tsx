...
export default function TopExperts() {
  return (
    <section className="py-20 bg-primary dark:bg-[#0a0a0a] dark:border-t dark:border-white/10">
          ...
          {topExperts.map((expert, index) => (
            ...
            >
              <Link
                ...
                className="block bg-white/5 border border-white/10 rounded-xl p-6 text-center hover:bg-white/10 transition"
              >
