    ...
    <main className="min-h-[80vh] flex items-center justify-center bg-white dark:bg-[#0a0a0a] px-4 py-12">
      <div className="w-full max-w-md border border-gray-border dark:border-white/10 rounded-xl p-8 bg-white dark:bg-white/5">
        ...
        <button
          ...
          className="w-full border border-gray-border dark:border-white/10 rounded-md py-2.5 text-sm font-medium text-primary dark:text-white hover:bg-gray-soft dark:hover:bg-white/10 transition flex items-center justify-center gap-2 disabled:opacity-60"
        >
